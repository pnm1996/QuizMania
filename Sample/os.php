	...
	<header>
        ...
        <div>
            <div>
                ...
                <form role="form" id='login' method="post" action="os_result.php">
                    <?php 
                    $res = mysqli_query($connect,"select * from os where difficulty='$difficulty' ORDER BY RAND()") or die("Connection Error");
