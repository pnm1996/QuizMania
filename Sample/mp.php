	...
	<header>
		...
		<div>
            <div>
                ...
                <form role="form" id='login' method="post" action="mp_result.php">
                    <?php 
                    $res = mysqli_query($connect,"select * from mp where difficulty='$difficulty' ORDER BY RAND()") or die("Connection Error");
                ...
                while($result=mysqli_fetch_array($res)){?>
                   ...
                   <br/>
                    ...
                    <?php } $i++;} ?>
                    <button id='sub' class= 'd' type='submit'>Finish</button>
                </form>
            </div>
        </div>
    </body>
