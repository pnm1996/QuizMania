	...
	<header>
        ...
        <div>
            <div>
                ...
                <form role="form" id='login' method="post" action="sooad_result.php">
                    <?php 
                    $res = mysqli_query($connect,"select * from sooad where difficulty='$difficulty' ORDER BY RAND()") or die("Connection Error");
