...
require 'config.php';
   ...
   $response=mysqli_query($connect,"select id,answer from cn where id IN($order)")  or die("Connection Error");
    ...
    <body>
        ...
        <div>
           <div> 
                ...
                <?php 
                    $res = mysqli_query($connect,"select answer,explanation,question from cn where difficulty='$difficulty' ORDER BY RAND()") or die("Connection Error");
